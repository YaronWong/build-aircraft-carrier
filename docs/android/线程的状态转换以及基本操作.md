...
- 实现callable接口，提交给ExecutorService返回的是异步执行的结果，另外，通常也可以利用FutureTask(Callable callable)将callable进行包装然后FeatureTask提交给ExecutorsService。如图：
  ...
  ![FutureTask接口实现关系](https://user-gold-cdn.xitu.io/2018/4/30/163159b250b111f7?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
转自：[掘金 ：你听___](https://juejin.im/post/6844903600309846023)